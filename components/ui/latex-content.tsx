  ...
  return (
    <div
      className={cn(
        ...
        "[&_code]:rounded [&_code]:bg-[#f4f4f4] dark:[&_code]:bg-[#262626] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:text-[0.875em] [&_code]:font-mono",
        "[&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre]:rounded-[8px] [&_pre]:bg-[#f4f4f4] dark:[&_pre]:bg-[#171717] [&_pre]:p-4 [&_pre_code]:bg-transparent [&_pre_code]:p-0",
        "[&_blockquote]:border-l-2 [&_blockquote]:border-[#e5e5e5] dark:[&_blockquote]:border-[#262626] [&_blockquote]:pl-4 [&_blockquote]:text-[#525252] dark:[&_blockquote]:text-[#a3a3a3]",
