  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <ChevronDownIcon className="pointer-events-none text-content-subtle" />
        }
      />
    </SelectPrimitive.Trigger>
  )
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "relative isolate max-h-(--available-height) w-(--anchor-width) min-w-36 origin-(--transform-origin) overflow-x-hidden overflow-y-auto overscroll-contain rounded-md border border-border-subtle bg-card p-1 text-card-foreground shadow-lg",
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.GroupLabel
      ...
      className={cn("px-2 py-1 font-eyebrow text-content-subtle", className)}
      {...props}
    />
  )
}
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        "top-0 flex w-full cursor-default items-center justify-center bg-card py-1 [&_svg]:size-4",
        className
      )}
      {...props}
    >
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      className={cn(
        "bottom-0 flex w-full cursor-default items-center justify-center bg-card py-1 [&_svg]:size-4",
        className
      )}
      {...props}
    >
